...
STAGE_2_META_PROMPT = """Read the user's last answer carefully. 
First, summarize their goal in one short sentence using their own words as much as possible. Do not repeat the user's words, instead try to reflect your understanding of their goal.
Then create a single clarifying question that checks whether you understood correctly.
