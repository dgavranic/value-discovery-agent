...
def log_final_feedback(state) -> None:
    ...
    try:
        ...
        metadata = {
            ...
            "version": "v4_interrupt_based"
        }
        # Create trace
        trace = client.trace(
            name="Value Discovery Session v4",
            input={
                "session_type": "value_discovery_v4_interrupt",
            ...
            output={
                ...
                "discovered_values": sorted_values[:7],
                "discovered_goals": goals,
                "suggested_actions": actions
            },
            metadata=metadata,
            tags=["value-discovery", "meta-agent-v4", "interrupt-based", "production"]
        )
...
def log_error(error_message: str, state, stage: str) -> None:
    ...
    try:
        client = opik.Opik()
        trace = client.trace(
            name=f"Error in Value Discovery v4 - {stage}",
            input={
                "stage": stage,
